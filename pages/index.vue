  ...
  <v-row justify="center">
    <v-col cols="12" sm="10" md="9" lg="7">
      <div class="text-center my-10">
        ...
        <p>
          Here you can check Demos we created you can easily use it. Its quite
        ...
        <v-col cols="12" md="7" lg="6" class="d-flex align-center">
          <div class="text-center text-md-left">
            ...
            <p class="text-white op-8 font-weight-regular">
              Pellentesque vehicula eros a dui pretium ornare. Phasellus congue
              vel quam nec luctus.In accumsan at eros in dignissim. Cras sodales
              nisi nonn accumsan.
            </p>
